        ...
        <section className='px-4 lg:px-24'>
            <div className='mb-14 relative'>
               ...
               <div className='md:w-[514px] md:h-[278px]  md:absolute md:z-10 md:bg-white md:bottom-0 md:flex md:flex-col md:justify-end md:pr-10 lg:w-[445px] lg:h-[357px] '>
                    <h1 className='text-[#33323D] text-[40px] font-bold leading-[42px] mb-5 font-irn lg:text-[50px] lg:leading-[50px]'>Hey, I’m Stanley Okoye and I love building beautiful websites </h1>
            ...
            <div className='mb-12 md:flex md:flex-row md:justify-between md:items-center lg:w-[1090px] '>
                ...
                <div className='lg:w-[480px]'>
                    ...
                    Based in Gillingham, England I’m comfortable working remotely and have valuable experience collaborating with remote teams.
